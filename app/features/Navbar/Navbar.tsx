...
const navLinks = [
  ...
  { label: "Best candidates", href: "/best-candidates" },
];
...
export function Navbar() {
  ...
  return (
    <header
      ref={containerRef}
      className={cn(
        "fixed top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 px-4 md:px-8"
      )}
    >
      <div className="container mx-auto flex h-14 max-w-screen-2xl items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <Link to="/" className="flex items-center gap-2">
            <Logo className="w-32 md:w-36 filter brightness-150" />
          </Link>
          {!isMobile && (
            <NavigationMenu>
